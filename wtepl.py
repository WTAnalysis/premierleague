...
# If there are no events yet, exit gracefully
        ...
        tab1, tab3, tab4 = st.tabs(["Player Overview", "Average Positions", "Custom Player Actions"])
        ...
        with tab1:
            ...
            if playername != "-- Select a player --":
                ...
                if not anderson.empty:
                    ...
                    ax_image = add_image(
                        wtaimaged, fig,
                        left=0.4275, bottom=-0.029, width=0.055,
                    ...
                    ax_image = add_image(
                        teamimage, fig,
                        left=0.490, bottom=-0.049, width=0.045,
                        alpha=1, interpolation='hanning'
                    )
                    ...
                    if playerimage is not None:
                        ax_image = add_image(
                            playerimage, fig,
                            left=0.5575, bottom=-0.039, width=0.025,
                            alpha=1, interpolation='hanning'
                        )
                    dpi = 600
                    st.pyplot(fig)
